...
class ORMTest extends TestCase
{
    ...
    /**
     * @var RQL2ORMMapperInterface
     */
    private $rql2ormMapper;
    ...
    protected function setUp(): void
    {
        ...
        $this->rql2ormMapper = RQL2ORMMapper::create();
    }
    ...
    public function test(): void
    {
        ...
        $this->rql2ormMapper->mapToQueryBuilder($qbTest1, $rql, false);
        ...
        $this->rql2ormMapper->mapToQueryBuilder($qbTest2, $rql, false);
    ...
    public function testInOperator(): void
    {
        ...
        $this->rql2ormMapper->mapToQueryBuilder($qb, $rql);
    ...
    public function testLike01(): void
    {
        ...
        $this->rql2ormMapper->mapToQueryBuilder($qbTest, $rql, false);
    ...
    public function testIsNullNode(): void
    {
        ...
        $this->rql2ormMapper->mapToQueryBuilder($qb, $rql, false);
    ...
    public function testIncompletePath(): void
    {
        $qb = $this->em->createQueryBuilder()
            ->select('products')
            ->from(Product::class, 'products');
        ...
        $this->expectException(VisitorException::class);
        $this->expectExceptionMessage('Incomplete field path "name"');
    ...
    public function testUnknownPath(): void
    {
        $qb = $this->em->createQueryBuilder()
            ->select('products')
            ->from(Product::class, 'products');
        $rql = 'isnull(unknown.test)';

        $this->expectException(VisitorException::class);
        $this->expectExceptionMessage('Unknown field path "products.unknown.test"');
